...
first find out what are the new changes are proposed, analyze it properly for all tiny changesm dont't miss any change.
then detect 2d bounding boxes around the changes are made in proposed images with comparision to the existing drawing. label it with the name of the change..
    """
    output_prompt = "Return just box_2d and labels as JSON. No extra text."
